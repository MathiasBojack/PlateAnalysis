...
switch model
    case 'KL'
        fig_name = [prjRoot '.\7.CaseStudy\meshSize\KLmodel\lambda_a_',...
            num2str(a),'_b_',num2str(b),'_h_',num2str(thickness_list),...
            '_n_', num2str(numDiv),'_KL2.tiff' ];
    case 'VK' 
        fig_name = [prjRoot '.\7.CaseStudy\meshSize\VKmodel\lambda_a_',...
            num2str(a),'_b_',num2str(b),'_h_',num2str(thickness_list),...
            '_n_', num2str(numDiv),'_KL2.mat' ];
end
...
lambda_name =  [prjRoot '.\7.CaseStudy\meshSize\KLmodel\lambda_a_',...
            num2str(a),'_b_',num2str(b),'_h_',num2str(thickness_list),...
            '_n_', num2str(numDiv),'_KL2.mat' ];
